...
//
// The server body lives here as a callable entry point so BOTH the standalone
// EdgeHop.Mcp.exe (Program.cs) and the unified `edgehop mcp` dispatcher command
// (EdgeHop.Tool) run the exact same server.
